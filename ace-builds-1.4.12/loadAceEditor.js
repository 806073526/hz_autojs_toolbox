...
function AutoX() {
    ...
    aceEditor.init = () => {
        ...
        editor.renderer.scroller.addEventListener("touchstart", function(e) {
            lastX = e.touches[0].clientX;
            lastY = e.touches[0].clientY;
        });

        editor.renderer.scroller.addEventListener("touchmove", function(e) {
            ...
            editor.session.setScrollTop(scrollTop - deltaY);
            editor.session.setScrollLeft(scrollLeft - deltaX);
            lastX = e.touches[0].clientX;
            lastY = e.touches[0].clientY;
        });
    ...
    aceEditor.setValue = (value) => {
        ...
        let cursor = {
            row: editor.session.selection.cursor.row,
            column: editor.session.selection.cursor.column
        };
...
let filePath = files.path("./ace-builds-1.4.12/editor.html");
