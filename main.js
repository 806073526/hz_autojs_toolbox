    ...
    ui.inflate(
        <card marginBottom="40px" contentPadding="50px 20px 50px 20px" cardBackgroundColor="#ffffff" cardCornerRadius="15px" cardElevation="15px">
            <vertical>
                ...
                <horizontal h="80px" id="绘制偏移" visibility="gone">
                    <text text="竖屏绘制y偏移:" textSize="16sp" h="*" w="450px" gravity="left|center" layout_weight="1" />
                    <input id="canvasOffset" hint="默认0,刘海屏建议110" h="*" w="*" margin="0" textSize="16sp" padding="15px 0 0 0" bg="#ffffff" inputType="text" gravity="left|center" layout_weight="2" />
                </horizontal>
