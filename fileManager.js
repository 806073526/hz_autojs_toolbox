        ...
        <list id="list" layout_weight="1">
            <card w="*" margin="2" >
                <horizontal bg="#FFFFFF">
                    ...
                    <text w="30" h="30" textSize="20sp" margin="5 10 5 10" layout_gravity="center" gravity="center" textColor="#FFFFFF" text="{{getFileExtension(file.name)}}" visibility="{{getFileVisibility(file)}}" bg="{{getTextBg(file.name)}}"/>
...
function getTextBg(fileName) {
    return fileName.endsWith(".js") ? "#99CC99" : "#888888";
}